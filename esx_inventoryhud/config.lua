...
Config.CloseUiItems = {"headbag", "tunerchip", "cigarette", "rarecigar", "cigar", "fixkit", "fixkit_large", "cloth", "notepad", "lotteryticket", "lockpick", "fishingrod", "crowbar", "transmitter","pfoglio", "binoculars", "headbag", "dice", "bulletproof_vest", "medikit", "bandage", "vicodin", "gauze", "morphine"}
